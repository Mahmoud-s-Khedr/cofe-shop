...
import { SuccessResponseDto, UserProfileResponseDto } from './dto/user-response.dto';
...
export class UsersController {
  ...
  updateMe(@CurrentUser() user: AuthUser, @Body() dto: UpdateProfileDto): Promise<Record<string, unknown>> {
  ...
  changePassword(@CurrentUser() user: AuthUser, @Body() dto: ChangePasswordDto): Promise<Record<string, unknown>> {
