...
export class ResetPasswordDto {
  @ApiProperty({ description: 'Phone number associated with the account', example: '+22200000000' })
  @IsString()
  @Length(7, 32)
  phone!: string;

  @ApiProperty({ description: 'One-time code received (4–8 digits)', example: '000000', minLength: 4, maxLength: 8 })
  @IsString()
  @Length(4, 8)
  code!: string;
